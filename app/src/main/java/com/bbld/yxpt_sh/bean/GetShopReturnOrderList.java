...
public class GetShopReturnOrderList {
    /**
     "status": 0,
     "mes": "操作成功",
     "count": 1,
    ...
    private List<GetShopReturnOrderListRes> list;
    ...
    public List<GetShopReturnOrderListRes> getList() {
        return list;
    }

    public void setList(List<GetShopReturnOrderListRes> list) {
        this.list = list;
    }

    public static class GetShopReturnOrderListRes{
        /**
         "NOID": "16",
         "NickName": " Toni",
