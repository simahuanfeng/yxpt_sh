...
public class GetTodayShopOrderList {
    /**
     "status": 0,
     "mes": "操作成功",
     "count": 1,
    ...
    private List<GetTodayShopOrderListRes> list;
    ...
    public List<GetTodayShopOrderListRes> getList() {
        return list;
    }

    public void setList(List<GetTodayShopOrderListRes> list) {
        this.list = list;
    }

    public static class GetTodayShopOrderListRes{
        /**
         "NOID": "16",
         "NickName": " Toni",
