...
public class OrderManagementActivity extends BaseActivity{
    ...
    private void setListeners() {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityManagerUtil.getInstance().finishActivity(OrderManagementActivity.this);
            }
        });
    ...
    private void loadData(final boolean isLoadMore) {
        Call<GetShopOrderList> call= RetrofitService.getInstance().getShopOrderList(new YXPT_SHToken(OrderManagementActivity.this).getToken(), pageIndex+"", pageSize+"");
    ...
    class ShopOrderListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if (view==null){
                view= LayoutInflater.from(getApplicationContext()).inflate(R.layout.item_lv_ordermanagement,null);
                ...
                holder.tvReturnStatus=(TextView)view.findViewById(R.id.tv_ReturnStatus);
            ...
            if(list.getIsReturn()==0){
                holder.tvEnterAmount.setTextColor(Color.rgb(225,66,88));
            }else{
                holder.tvEnterAmount.setTextColor(Color.rgb(153,153,153));
            }
            ...
            holder.tvReturnStatus.setText(""+list.getReturnStatus());
    ...
    public int getContentView() {
        return R.layout.activity_ordermanagement;
    }
}
